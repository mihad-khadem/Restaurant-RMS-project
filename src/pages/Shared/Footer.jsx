  ...
  return (
    <div>
      <footer className=" text-white">
        <div className="flex justify-center mx-auto">
          <div className="bg-[#111827] w-2/4 p-10">
            <nav>
              ...
              <a className="link link-hover mr-2">Contact</a>
              <a className="link link-hover mr-2">Jobs</a>
        ...
        <footer className="footer items-center p-4 bg-[#151515] text-neutral-content">
          <aside className="items-center  grid-flow-col">
            <a href=""><img src="/logo.png" className="w-6" alt="" /></a>
